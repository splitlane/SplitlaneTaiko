...
},
{
    ...
    Run = function(line)
        line = tonumber(line)
        Command.Output(History[line > 0 and line or line < 0 and #History + line] .. '\n')
    end
},
{
    Name = 'random',
    ...
    Run = function(s, e)
        Command.Output(math.random(s, e) .. '\n')
    end
},
{
    Name = 'brainfuck',
